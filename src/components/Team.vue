    ...
    &__socials-item
      ...
      &--fb
        ...
        &:after
          ...
          width 15px
          height 30px
          background url('../assets/fb-hover.svg');
          background-size: cover
          z-index: 0
          top 8px
          opacity 0
      ...
      &--tw
        ...
        &:after
          ...
          position absolute
          height 24px
          background url('../assets/tw-hover.svg');
          background-size: cover
          z-index: 1
          top 10px
          width: 28px
      ...
      &--ms
        ...
        &:after
          ...
          width 30px
          height 29px
          background url('../assets/ms-hover.svg');
          background-size: cover
          z-index: 1
          top 10px
          opacity 0
      ...
      &--round
        ...
        &:after
          ...
          width 29px
          height 29px
          background url('../assets/round-hover.svg');
          background-size: cover
          z-index: 1
          top 10px
          opacity 0
